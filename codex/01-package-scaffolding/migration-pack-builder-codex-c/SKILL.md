---
name: migration-pack-builder-codex-c
description: Generates retrofit plans, replacement lists, and managed-surface migration artifacts for existing repos. Use this when the user or repo work clearly points at migration pack builder or a task in the "Package Scaffolding Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for one-off edits that do not benefit from a reusable workflow or package contract.
license: Apache-2.0
compatibility:
  clients: [openai-codex, gemini-cli, opencode, github-copilot]
metadata:
  owner: codex
  domain: migration-pack-builder
  maturity: draft
  risk: low
  tags: [migration, pack, builder]
---

# Purpose

Generates retrofit plans, replacement lists, and managed-surface migration artifacts for existing repos.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at migration pack builder
- a task in the "Package Scaffolding Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around migration pack builder

# Do not use this skill when

- the task is really about one-off edits that do not benefit from a reusable workflow or package contract
- If the task is more specifically about `community-skill-harvester` or `stack-profile-detector`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Normalize the inputs, constraints, and success conditions before generating anything for Migration Pack Builder.
