---
name: tailwind-shadcn-codex-c
description: Standardizes utility-class styling, component composition, and design-system reuse in Tailwind-based projects. Use this when the user or repo work clearly points at tailwind and shadcn/ui or a task in the "Web, Frontend, and Design Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for backend-only or infrastructure-only work.
license: Apache-2.0
compatibility:
...
Standardizes utility-class styling, component composition, and design-system reuse in Tailwind-based projects.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at tailwind and shadcn/ui
- a task in the "Web, Frontend, and Design Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around tailwind and shadcn/ui

# Do not use this skill when

- the task is really about backend-only or infrastructure-only work
- If the task is more specifically about `vue` or `svelte`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Detect the actual UI stack, rendering constraints, and component boundaries involved in Tailwind and shadcn/ui.
