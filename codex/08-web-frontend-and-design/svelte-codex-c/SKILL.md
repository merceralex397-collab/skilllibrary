---
name: svelte-codex-c
description: Applies Svelte component, store, and routing patterns when the stack calls for it. Use this when the user or repo work clearly points at svelte or a task in the "Web, Frontend, and Design Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for backend-only or infrastructure-only work.
license: Apache-2.0
compatibility:
...
Applies Svelte component, store, and routing patterns when the stack calls for it.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at svelte
- a task in the "Web, Frontend, and Design Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around svelte
...
1. Detect the actual UI stack, rendering constraints, and component boundaries involved in Svelte.
