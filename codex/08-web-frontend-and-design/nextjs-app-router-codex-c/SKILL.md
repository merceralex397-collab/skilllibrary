---
name: nextjs-app-router-codex-c
description: Handles route structure, server/client boundaries, data fetching, and deployment caveats for App Router projects. Use this when the user or repo work clearly points at next.js app router or a task in the "Web, Frontend, and Design Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for backend-only or infrastructure-only work.
license: Apache-2.0
compatibility:
...
Handles route structure, server/client boundaries, data fetching, and deployment caveats for App Router projects.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at next.js app router
- a task in the "Web, Frontend, and Design Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around next.js app router

# Do not use this skill when

- the task is really about backend-only or infrastructure-only work
- If the task is more specifically about `react-typescript` or `vue`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Detect the actual UI stack, rendering constraints, and component boundaries involved in Next.js App Router.
