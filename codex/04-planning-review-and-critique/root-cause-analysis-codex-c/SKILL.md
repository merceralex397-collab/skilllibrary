---
name: root-cause-analysis-codex-c
description: Investigates why a bug, outage, or process failure happened and what underlying cause actually mattered. Use this when the user or repo work clearly points at root cause analysis or a task in the "Planning, Review, and Critique" family needs repeatable procedure rather than ad hoc prompting. Do not use for ordinary implementation work where no review, critique, or comparison is needed.
license: Apache-2.0
compatibility:
...
Investigates why a bug, outage, or process failure happened and what underlying cause actually mattered.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at root cause analysis
- a task in the "Planning, Review, and Critique" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around root cause analysis

# Do not use this skill when

- the task is really about ordinary implementation work where no review, critique, or comparison is needed
- If the task is more specifically about `skeptic-pass` or `failure-mode-analysis`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the decision, plan, or implementation surface being reviewed for Root Cause Analysis.
