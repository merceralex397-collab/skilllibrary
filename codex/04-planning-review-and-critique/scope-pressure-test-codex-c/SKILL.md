---
name: scope-pressure-test-codex-c
description: Pushes on whether the requested scope is realistic for the timeline, repo state, and available agents. Use this when the user or repo work clearly points at scope pressure test or a task in the "Planning, Review, and Critique" family needs repeatable procedure rather than ad hoc prompting. Do not use for ordinary implementation work where no review, critique, or comparison is needed.
license: Apache-2.0
compatibility:
...
Pushes on whether the requested scope is realistic for the timeline, repo state, and available agents.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at scope pressure test
- a task in the "Planning, Review, and Critique" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around scope pressure test

# Do not use this skill when

- the task is really about ordinary implementation work where no review, critique, or comparison is needed
- If the task is more specifically about `assumptions-audit` or `contradiction-finder`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the decision, plan, or implementation surface being reviewed for Scope Pressure Test.
