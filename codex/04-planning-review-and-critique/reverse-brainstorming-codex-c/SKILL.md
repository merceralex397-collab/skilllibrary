---
name: reverse-brainstorming-codex-c
description: Asks how to make the plan fail, become slow, or become unreliable, then inverts the answers into protections. Use this when the user or repo work clearly points at reverse brainstorming or a task in the "Planning, Review, and Critique" family needs repeatable procedure rather than ad hoc prompting. Do not use for ordinary implementation work where no review, critique, or comparison is needed.
license: Apache-2.0
compatibility:
...
Asks how to make the plan fail, become slow, or become unreliable, then inverts the answers into protections.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at reverse brainstorming
- a task in the "Planning, Review, and Critique" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around reverse brainstorming

# Do not use this skill when

- the task is really about ordinary implementation work where no review, critique, or comparison is needed
- If the task is more specifically about `failure-mode-analysis` or `root-cause-analysis`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the decision, plan, or implementation surface being reviewed for Reverse Brainstorming.
