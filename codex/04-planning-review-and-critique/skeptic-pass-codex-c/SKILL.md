---
name: skeptic-pass-codex-c
description: Runs a deliberately doubtful review over a proposal to catch optimism bias and hand-wavy claims. Use this when the user or repo work clearly points at skeptic pass or a task in the "Planning, Review, and Critique" family needs repeatable procedure rather than ad hoc prompting. Do not use for ordinary implementation work where no review, critique, or comparison is needed.
license: Apache-2.0
compatibility:
...
Runs a deliberately doubtful review over a proposal to catch optimism bias and hand-wavy claims.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at skeptic pass
- a task in the "Planning, Review, and Critique" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around skeptic pass

# Do not use this skill when

- the task is really about ordinary implementation work where no review, critique, or comparison is needed
- If the task is more specifically about `acceptance-criteria-hardening` or `gap-analysis`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the decision, plan, or implementation surface being reviewed for Skeptic Pass.
