---
name: steelman-codex-c
description: Rebuilds an idea or plan in its strongest plausible form before judging it. Use this when the user or repo work clearly points at steelman or a task in the "Planning, Review, and Critique" family needs repeatable procedure rather than ad hoc prompting. Do not use for ordinary implementation work where no review, critique, or comparison is needed.
license: Apache-2.0
compatibility:
