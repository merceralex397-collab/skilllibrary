---
name: manager-hierarchy-design-codex-c
description: Decides when to introduce managers, section leads, or a second orchestration tier above team leaders. Use this when the user or repo work clearly points at manager hierarchy design or a task in the "Agentic Orchestration and Autonomy" family needs repeatable procedure rather than ad hoc prompting. Do not use for small single-agent tasks where delegation overhead would be larger than the work.
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [manager, hierarchy, design]
---

# Purpose

Decides when to introduce managers, section leads, or a second orchestration tier above team leaders.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at manager hierarchy design
- a task in the "Agentic Orchestration and Autonomy" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around manager hierarchy design

# Do not use this skill when

- the task is really about small single-agent tasks where delegation overhead would be larger than the work
- If the task is more specifically about `human-interrupt-handling` or `goal-decomposition`, prefer that skill instead.
