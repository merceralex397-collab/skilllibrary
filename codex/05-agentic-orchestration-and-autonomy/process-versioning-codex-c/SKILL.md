---
name: process-versioning-codex-c
description: Useful for repair, migration, and audit history. Use this when the user or repo work clearly points at p2 or a task in the "Agentic Orchestration and Autonomy" family needs repeatable procedure rather than ad hoc prompting. Do not use for small single-agent tasks where delegation overhead would be larger than the work.
license: Apache-2.0
compatibility:
...
Useful for repair, migration, and audit history.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at p2
- a task in the "Agentic Orchestration and Autonomy" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around p2

# Do not use this skill when

- the task is really about small single-agent tasks where delegation overhead would be larger than the work
- If the task is more specifically about `multi-agent-debugging` or `autonomous-backlog-maintenance`, prefer that skill instead.
