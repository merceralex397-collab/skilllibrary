---
name: starcraft-data-analysis-codex-c
description: Handles StarCraft patch, balance, replay, or meta-analysis in a structured way. Use this when the user or repo work clearly points at starcraft data analysis or a task in the "Business, Research, and Optional Domain Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for quick factual lookups with no synthesis, comparison, or decision support.
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [starcraft, data, analysis]
---

# Purpose

Handles StarCraft patch, balance, replay, or meta-analysis in a structured way.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at starcraft data analysis
...
- a plan, ticket, or repo state would benefit from explicit guardrails around starcraft data analysis

# Do not use this skill when

- the task is really about quick factual lookups with no synthesis, comparison, or decision support
- If the task is more specifically about `competitor-teardown` or `business-idea-evaluation`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the exact question and decision boundary for StarCraft Data Analysis.
