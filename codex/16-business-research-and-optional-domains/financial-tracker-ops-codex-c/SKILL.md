---
name: financial-tracker-ops-codex-c
description: Maintains debt, cashflow, ledger, and projection-style artifacts with audit-friendly structure. Use this when the user or repo work clearly points at financial tracker ops or a task in the "Business, Research, and Optional Domain Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for quick factual lookups with no synthesis, comparison, or decision support.
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [financial, tracker, ops]
---

# Purpose

Maintains debt, cashflow, ledger, and projection-style artifacts with audit-friendly structure.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at financial tracker ops
...
- a plan, ticket, or repo state would benefit from explicit guardrails around financial tracker ops

# Do not use this skill when

- the task is really about quick factual lookups with no synthesis, comparison, or decision support
- If the task is more specifically about `spreadsheet-analysis` or `market-research`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the exact question and decision boundary for Financial Tracker Ops.
