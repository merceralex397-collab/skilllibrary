---
name: domain-scouting-codex-c
description: Finds and evaluates domain names or naming opportunities under practical constraints. Use this when the user or repo work clearly points at domain scouting or a task in the "Business, Research, and Optional Domain Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for quick factual lookups with no synthesis, comparison, or decision support.
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [domain, scouting]
---

# Purpose

Finds and evaluates domain names or naming opportunities under practical constraints.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at domain scouting
...
- a plan, ticket, or repo state would benefit from explicit guardrails around domain scouting
...
1. Define the exact question and decision boundary for Domain Scouting.
