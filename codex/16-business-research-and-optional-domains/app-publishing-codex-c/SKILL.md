---
name: app-publishing-codex-c
description: Covers Android/iOS publishing steps, accounts, assets, and release caveats for app shipping. Use this when the user or repo work clearly points at app publishing or a task in the "Business, Research, and Optional Domain Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for quick factual lookups with no synthesis, comparison, or decision support.
license: Apache-2.0
compatibility:
...
Covers Android/iOS publishing steps, accounts, assets, and release caveats for app shipping.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at app publishing
...
- a plan, ticket, or repo state would benefit from explicit guardrails around app publishing

# Do not use this skill when

- the task is really about quick factual lookups with no synthesis, comparison, or decision support
- If the task is more specifically about `starcraft-data-analysis` or `image-prompt-direction`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the exact question and decision boundary for App Publishing.
