---
name: worldbuilding-research-codex-c
description: Researches and structures lore, cultures, systems, and consistency references for fictional worlds. Use this when the user or repo work clearly points at worldbuilding research or a task in the "Business, Research, and Optional Domain Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for quick factual lookups with no synthesis, comparison, or decision support.
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [worldbuilding, research]
---

# Purpose

Researches and structures lore, cultures, systems, and consistency references for fictional worlds.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at worldbuilding research
...
- a plan, ticket, or repo state would benefit from explicit guardrails around worldbuilding research

# Do not use this skill when

- the task is really about quick factual lookups with no synthesis, comparison, or decision support
- If the task is more specifically about `image-prompt-direction` or `app-publishing`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the exact question and decision boundary for Worldbuilding Research.
