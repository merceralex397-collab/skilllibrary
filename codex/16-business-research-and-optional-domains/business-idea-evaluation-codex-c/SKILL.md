---
name: business-idea-evaluation-codex-c
description: Evaluates ideas across feasibility, moat, cost, risk, and revenue plausibility. Use this when the user or repo work clearly points at business idea evaluation or a task in the "Business, Research, and Optional Domain Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for quick factual lookups with no synthesis, comparison, or decision support.
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [business, idea, evaluation]
---

# Purpose

Evaluates ideas across feasibility, moat, cost, risk, and revenue plausibility.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at business idea evaluation
...
- a plan, ticket, or repo state would benefit from explicit guardrails around business idea evaluation

# Do not use this skill when

- the task is really about quick factual lookups with no synthesis, comparison, or decision support
- If the task is more specifically about `cv-cover-letter` or `competitor-teardown`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the exact question and decision boundary for Business Idea Evaluation.
