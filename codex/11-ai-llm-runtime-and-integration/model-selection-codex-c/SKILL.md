---
name: model-selection-codex-c
description: Chooses a model based on task shape, hardware, latency, cost, context, and risk tolerance. Use this when the user or repo work clearly points at model selection or a task in the "AI / LLM Runtime and Integration Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for ordinary software tasks with no model, inference, evaluation, or agent-runtime concerns.
license: Apache-2.0
compatibility:
