---
name: ollama-codex-c
description: Applies Ollama-specific conventions for model management, serving, and local integration. Use this when the user or repo work clearly points at ollama or a task in the "AI / LLM Runtime and Integration Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for ordinary software tasks with no model, inference, evaluation, or agent-runtime concerns.
license: Apache-2.0
compatibility:
