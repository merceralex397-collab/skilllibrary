---
name: llm-integration-codex-c
description: Integrates AI capabilities into a product or service with safe boundaries, cost awareness, and useful UX. Use this when the work involves models, inference, training, evaluation, or LLM system design or a task in the "AI / LLM Runtime and Integration Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for ordinary software tasks with no model, inference, evaluation, or agent-runtime concerns.
license: Apache-2.0
compatibility:
...
Integrates AI capabilities into a product or service with safe boundaries, cost awareness, and useful UX.
...
- a plan, ticket, or repo state would benefit from explicit guardrails around llm integration
...
1. Clarify the runtime goal, model boundaries, and interfaces involved in LLM Integration.
