---
name: bash-codex-c
description: Applies shell scripting safety, quoting, error handling, and portable command composition. Use this when the user or repo work clearly points at bash or a task in the "CLI, Systems, and Ops Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for application logic changes that do not affect delivery, runtime, or operator workflow.
license: Apache-2.0
compatibility:
