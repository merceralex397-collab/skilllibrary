---
name: performance-profiling-games-codex-c
description: Measures frame time, memory, loading, and engine-specific performance regressions. Use this when the user or repo work clearly points at game performance profiling or a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for non-creative maintenance work where engine, art, or design systems are irrelevant.
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [performance, profiling, games]
---

# Purpose

Measures frame time, memory, loading, and engine-specific performance regressions.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at game performance profiling
- a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around game performance profiling

# Do not use this skill when

- the task is really about non-creative maintenance work where engine, art, or design systems are irrelevant
- If the task is more specifically about `game-ui-hud` or `asset-pipeline`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the player, user, or audience outcome that Game Performance Profiling is meant to improve.
