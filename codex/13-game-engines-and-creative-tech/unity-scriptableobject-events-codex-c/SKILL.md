---
name: unity-scriptableobject-events-codex-c
description: Uses ScriptableObjects and event-driven patterns cleanly inside Unity. Use this when the user or repo work clearly points at unity scriptableobject events or a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for non-creative maintenance work where engine, art, or design systems are irrelevant.
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [unity, scriptableobject, events]
---

# Purpose

Uses ScriptableObjects and event-driven patterns cleanly inside Unity.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at unity scriptableobject events
- a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around unity scriptableobject events

# Do not use this skill when

- the task is really about non-creative maintenance work where engine, art, or design systems are irrelevant
- If the task is more specifically about `ai-npc-behavior` or `blueprint-patterns`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the player, user, or audience outcome that Unity ScriptableObject Events is meant to improve.
