---
name: ue5-blueprint-codex-c
description: A more explicitly named Unreal Blueprint external seed reflecting public rule examples. Use this when the user or repo work clearly points at ue5 blueprint or a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for non-creative maintenance work where engine, art, or design systems are irrelevant.
license: Apache-2.0
compatibility:
...
A more explicitly named Unreal Blueprint external seed reflecting public rule examples.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at ue5 blueprint
- a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around ue5 blueprint

# Do not use this skill when

- the task is really about non-creative maintenance work where engine, art, or design systems are irrelevant
- If the task is more specifically about `worldbuilding-lore-systems` or `algorithmic-art`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the player, user, or audience outcome that UE5 Blueprint is meant to improve.
