---
name: blueprint-patterns-codex-c
description: Captures good Unreal Blueprint structure, communication, and anti-spaghetti practices. Use this when the user or repo work clearly points at blueprint patterns or a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for non-creative maintenance work where engine, art, or design systems are irrelevant.
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [blueprint, patterns]
---

# Purpose

Captures good Unreal Blueprint structure, communication, and anti-spaghetti practices.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at blueprint patterns
- a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around blueprint patterns

# Do not use this skill when

- the task is really about non-creative maintenance work where engine, art, or design systems are irrelevant
- If the task is more specifically about `save-load-state` or `ai-npc-behavior`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the player, user, or audience outcome that Blueprint Patterns is meant to improve.
