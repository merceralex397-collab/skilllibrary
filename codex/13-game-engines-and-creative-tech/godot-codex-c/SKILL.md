---
name: godot-codex-c
description: Applies Godot scene, script, signal, and project organization patterns. Use this when the project uses Godot as an engine or primary runtime or a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for non-creative maintenance work where engine, art, or design systems are irrelevant.
license: Apache-2.0
compatibility:
