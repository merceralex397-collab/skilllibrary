---
name: worldbuilding-lore-systems-codex-c
description: Structures deities, factions, history, settings, and lore consistency for world-heavy projects. Use this when the user or repo work clearly points at worldbuilding and lore systems or a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for non-creative maintenance work where engine, art, or design systems are irrelevant.
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [worldbuilding, lore, systems]
---

# Purpose

Structures deities, factions, history, settings, and lore consistency for world-heavy projects.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at worldbuilding and lore systems
- a task in the "Game Engines and Creative Tech Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around worldbuilding and lore systems

# Do not use this skill when

- the task is really about non-creative maintenance work where engine, art, or design systems are irrelevant
- If the task is more specifically about `unity-scriptableobject-events` or `multiplayer-netcode`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the player, user, or audience outcome that Worldbuilding and Lore Systems is meant to improve.
