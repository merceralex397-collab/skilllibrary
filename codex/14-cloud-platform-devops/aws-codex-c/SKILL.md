---
name: aws-codex-c
description: Applies AWS service selection, IAM, deployment, and operational guardrails when AWS is chosen. Use this when the user or repo work clearly points at aws or a task in the "Cloud, Platform, and DevOps Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for application logic changes that do not affect delivery, runtime, or operator workflow.
license: Apache-2.0
compatibility:
...
Applies AWS service selection, IAM, deployment, and operational guardrails when AWS is chosen.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at aws
- a task in the "Cloud, Platform, and DevOps Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around aws
...
1. Define the target environment, promotion path, and operator constraints for AWS.
