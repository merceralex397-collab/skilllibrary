---
name: cloud-deploy-codex-c
description: A broader deployment seed for choosing and applying a cloud target cleanly. Use this when the user or repo work clearly points at cloud deploy or a task in the "Cloud, Platform, and DevOps Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for application logic changes that do not affect delivery, runtime, or operator workflow.
license: Apache-2.0
compatibility:
...
A broader deployment seed for choosing and applying a cloud target cleanly.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at cloud deploy
- a task in the "Cloud, Platform, and DevOps Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around cloud deploy

# Do not use this skill when

- the task is really about application logic changes that do not affect delivery, runtime, or operator workflow
- If the task is more specifically about `self-hosting-ops` or `cloudflare-worker-patterns`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the target environment, promotion path, and operator constraints for Cloud Deploy.
