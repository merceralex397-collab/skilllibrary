...
- a plan, ticket, or repo state would benefit from explicit guardrails around mcp chatgpt app bridge
...
- If the task is more specifically about `mcp-migration-retrofit` or `mcp-multi-tenant-design`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Clarify the host, transport, and surface area involved in MCP ChatGPT App Bridge.
