...
Covers end-to-end MCP server design, tool surfaces, resources, prompts, and repo conventions.
...
- a plan, ticket, or repo state would benefit from explicit guardrails around mcp development
...
- If the task is more specifically about `mcp-tool-design` or `mcp-testing-evals`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Clarify the host, transport, and surface area involved in MCP Development.
