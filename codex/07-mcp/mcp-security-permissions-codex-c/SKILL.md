...
- a plan, ticket, or repo state would benefit from explicit guardrails around mcp security and permissions
...
1. Clarify the host, transport, and surface area involved in MCP Security and Permissions.
