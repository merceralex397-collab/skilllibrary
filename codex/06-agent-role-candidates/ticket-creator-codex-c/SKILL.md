---
name: ticket-creator-codex-c
description: Creates follow-up tickets only from actual evidence, not vague intentions or duplicated complaints. Use this when the user or repo work clearly points at ticket creator or a task in the "Agent Role Candidate Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for tasks outside the narrow ticket creator role.
license: Apache-2.0
compatibility:
...
- the user or repo work clearly points at ticket creator
- a task in the "Agent Role Candidate Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around ticket creator

# Do not use this skill when

- the task is really about tasks outside the narrow ticket creator role
...
1. Restate the narrow role this skill is allowed to perform for Ticket Creator.
