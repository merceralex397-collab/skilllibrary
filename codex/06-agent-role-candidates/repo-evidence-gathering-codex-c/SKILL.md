---
name: repo-evidence-gathering-codex-c
description: Collects focused repository evidence for another specialist without making edits. Use this when the user or repo work clearly points at repo evidence gathering or a task in the "Agent Role Candidate Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for tasks outside the narrow repo evidence gathering role.
license: Apache-2.0
compatibility:
...
- the user or repo work clearly points at repo evidence gathering
- a task in the "Agent Role Candidate Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around repo evidence gathering

# Do not use this skill when

- the task is really about tasks outside the narrow repo evidence gathering role
- If the task is more specifically about `qa-validation` or `docs-handoff`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Restate the narrow role this skill is allowed to perform for Repo Evidence Gathering.
