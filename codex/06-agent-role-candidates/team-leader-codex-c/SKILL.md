---
name: team-leader-codex-c
description: Coordinates specialists, checks evidence first, and advances work without owning all implementation directly. Use this when the user or repo work clearly points at team leader or a task in the "Agent Role Candidate Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for tasks outside the narrow team leader role.
license: Apache-2.0
compatibility:
...
- the user or repo work clearly points at team leader
- a task in the "Agent Role Candidate Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around team leader

# Do not use this skill when

- the task is really about tasks outside the narrow team leader role
- If the task is more specifically about `planner` or `backlog-verifier`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Restate the narrow role this skill is allowed to perform for Team Leader.
