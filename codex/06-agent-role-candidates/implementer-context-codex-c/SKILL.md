---
name: implementer-context-codex-c
description: Implements context, retrieval, routing, or observability changes under an approved plan. Use this when the user or repo work clearly points at implementer context or a task in the "Agent Role Candidate Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for tasks outside the narrow implementer context role.
license: Apache-2.0
compatibility:
...
Implements context, retrieval, routing, or observability changes under an approved plan.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at implementer context
- a task in the "Agent Role Candidate Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around implementer context

# Do not use this skill when

- the task is really about tasks outside the narrow implementer context role
- If the task is more specifically about `implementer-hub` or `implementer-node-agent`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Restate the narrow role this skill is allowed to perform for Implementer Context.
