---
name: github-prior-art-research-codex-c
description: Looks for similar repos, patterns, and implementations on GitHub and returns grounded findings. Use this when the user or repo work clearly points at github prior art research or a task in the "Agent Role Candidate Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for tasks outside the narrow github prior art research role.
license: Apache-2.0
compatibility:
...
- the user or repo work clearly points at github prior art research
- a task in the "Agent Role Candidate Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around github prior art research

# Do not use this skill when

- the task is really about tasks outside the narrow github prior art research role
- If the task is more specifically about `docs-handoff` or `repo-evidence-gathering`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Restate the narrow role this skill is allowed to perform for GitHub Prior Art Research.
