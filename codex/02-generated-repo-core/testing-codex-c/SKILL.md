---
name: testing-codex-c
description: Chooses and structures appropriate testing layers for the current stack: unit, integration, e2e, snapshot, or property-based. Use this when the user or repo work clearly points at testing or a task in the "Generated Repo Core Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for ordinary implementation work where no review, critique, or comparison is needed.
license: Apache-2.0
compatibility:
