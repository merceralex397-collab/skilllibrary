---
name: auth-patterns-codex-c
description: Explains authentication, session, token, and authorization rules for the current stack. Use this when the user or repo work clearly points at auth patterns or a task in the "Generated Repo Core Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for adjacent tasks where a more specific skill already covers the job.
license: Apache-2.0
compatibility:
