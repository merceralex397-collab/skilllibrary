---
name: performance-baseline-codex-c
description: Defines what to measure, what tools to use, and what thresholds or regressions matter for the stack. Use this when the user or repo work clearly points at performance baseline or a task in the "Generated Repo Core Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for adjacent tasks where a more specific skill already covers the job.
license: Apache-2.0
compatibility:
...
Defines what to measure, what tools to use, and what thresholds or regressions matter for the stack.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at performance baseline
- a task in the "Generated Repo Core Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around performance baseline

# Do not use this skill when

- the task is really about adjacent tasks where a more specific skill already covers the job
- If the task is more specifically about `external-api-client` or `error-handling`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the task boundary for Performance Baseline.
