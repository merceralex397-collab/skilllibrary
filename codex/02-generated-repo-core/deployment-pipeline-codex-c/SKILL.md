---
name: deployment-pipeline-codex-c
description: Defines CI/CD, release, deployment, and rollback procedure for the chosen target. Use this when the user or repo work clearly points at deployment pipeline or a task in the "Generated Repo Core Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for adjacent tasks where a more specific skill already covers the job.
license: Apache-2.0
compatibility:
