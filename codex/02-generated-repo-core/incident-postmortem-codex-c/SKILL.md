---
name: incident-postmortem-codex-c
description: Turns failures or regressions into structured root-cause, corrective-action, and prevention artifacts. Use this when the user or repo work clearly points at incident postmortem or a task in the "Generated Repo Core Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for adjacent tasks where a more specific skill already covers the job.
license: Apache-2.0
compatibility:
...
Turns failures or regressions into structured root-cause, corrective-action, and prevention artifacts.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at incident postmortem
- a task in the "Generated Repo Core Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around incident postmortem

# Do not use this skill when

- the task is really about adjacent tasks where a more specific skill already covers the job
- If the task is more specifically about `dependency-upgrades` or `release-engineering`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Define the task boundary for Incident Postmortem.
