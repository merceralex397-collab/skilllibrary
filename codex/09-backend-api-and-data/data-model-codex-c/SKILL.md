---
name: data-model-codex-c
description: Designs entities, relationships, invariants, and migration-sensitive structure in the data layer. Use this when the user or repo work clearly points at data model or a task in the "Backend, API, and Data Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for pure frontend styling or content-only tasks.
license: Apache-2.0
compatibility:
...
Designs entities, relationships, invariants, and migration-sensitive structure in the data layer.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at data model
- a task in the "Backend, API, and Data Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around data model

# Do not use this skill when

- the task is really about pure frontend styling or content-only tasks
- If the task is more specifically about `api-debugging` or `api-contracts`, prefer that skill instead.
- the relevant files, runtime, or deliverable type are already covered by a more specific active skill

# Operating procedure

1. Map the service boundary, data flow, and failure surface affected by Data Model.
