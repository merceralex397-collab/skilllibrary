---
name: express-node-codex-c
description: Applies Express and Node service structure, middleware, validation, and routing conventions. Use this when the user or repo work clearly points at express and node or a task in the "Backend, API, and Data Skills" family needs repeatable procedure rather than ad hoc prompting. Do not use for pure frontend styling or content-only tasks.
license: Apache-2.0
compatibility:
...
Applies Express and Node service structure, middleware, validation, and routing conventions.

# When to use this skill

Use this skill when:

- the user or repo work clearly points at express and node
- a task in the "Backend, API, and Data Skills" family needs repeatable procedure rather than ad hoc prompting
- a plan, ticket, or repo state would benefit from explicit guardrails around express and node
...
1. Map the service boundary, data flow, and failure surface affected by Express and Node.
