...
2. Verify before trust.
   Validate signatures and basic envelope shape before mutating internal state. Treat unverifiable or malformed events as hostile input.
