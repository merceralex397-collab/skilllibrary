...
> Source: https://github.com/openai/skills/tree/main/skills/.curated skills/.curated/figma
...
**Authentication**: Use a Personal Access Token in the `X-Figma-Token` header, or OAuth 2 for team integrations.
