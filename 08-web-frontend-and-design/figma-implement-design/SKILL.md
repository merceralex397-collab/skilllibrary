...
metadata:
  owner: codex
  domain: figma-implement-design
  maturity: curated
  risk: low
  tags: [figma, design, implementation]
---

> Source: https://github.com/openai/skills/tree/main/skills/.curated skills/.curated/figma-implement-design
